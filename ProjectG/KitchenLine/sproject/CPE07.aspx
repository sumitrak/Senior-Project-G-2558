<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPE07.aspx.cs" Inherits="sproject.CPE07" %>
...
<body style="height: 1308px">
    ...
    <div class="cover">
        ...
        <div class="menu">
            ...
            <asp:LinkButton CssClass="x" ID="LinkButton2" runat="server" ForeColor="White" >แบบฟอร์ม</asp:LinkButton>
        ...
        <table style="width:100%; height: 831px;">
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <div>
                    <asp:Label ID="Label2" runat="server" Font-Size="X-Large" Text="CPE07 - แบบประเมินโครงงาน"></asp:Label>
                    </div>
                </td>
                <td class="auto-style3">&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <table class="auto-style10">
                        ...
                        <tr>
                            <td class="auto-style14">1.&nbsp; ผลการดำเนินงาน</td>
                        ...
                        <tr>
                            <td class="auto-style14">2.&nbsp; ความสมบูรณ์ของรายงานโครงงาน</td>
                            <td class="auto-style13">
                        ...
                        <tr>
                            <td class="auto-style15">3.&nbsp; ความรู้ความเข้าใจขอนิสิตเกี่ยวกับโครงงาน</td>
