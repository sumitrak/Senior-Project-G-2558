<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tSeeHistory.aspx.cs" Inherits="sproject.tSeeHistory" %>
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="700px" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" PageSize="8">
                            ...
                            <Columns>
                                <asp:BoundField DataField="PID" HeaderText="รหัส" SortExpression="PID" />
                                <asp:BoundField DataField="PNameTH" HeaderText="ชื่อโครงงาน" SortExpression="PNameTH" />
                                <asp:BoundField DataField="FormNo" HeaderText="ฟอร์ม" SortExpression="FormNo" />
                                <asp:BoundField DataField="NameID" HeaderText="โดย" SortExpression="NameID" />
                                <asp:BoundField DataField="operator" HeaderText="ทำการ" SortExpression="operator" />
