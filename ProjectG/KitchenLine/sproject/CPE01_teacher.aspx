<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPE01_teacher.aspx.cs" Inherits="sproject.CPE01_teacher" %>
        ...
        <table style="width:100%; height: 831px;">
            ...
            <tr>
                ...
                <td class="auto-style2">
                    ...
                    <div style="float:left;">
                        <asp:Button ID="Button3" runat="server" Text="เพิ่ม/ลบ" Enabled="False" />
                    </div>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    ...
                    <div style="float:left;">
                        <asp:Button ID="Button4" runat="server" Text="เพิ่ม/ลบ" Enabled="False" />                    
                    </div>
                </td>
                <td class="auto-style3">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style2">
                    ...
                    <div style="float:left;">                        
                        <asp:Button ID="Button5" runat="server" Text="เพิ่ม/ลบ" Enabled="False" />                    
                    </div>
                </td>
                <td class="auto-style3">&nbsp;</td>
            </tr>
