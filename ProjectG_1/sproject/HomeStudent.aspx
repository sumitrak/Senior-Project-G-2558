...
UNION SELECT project_5.PID, project_5.PNameTH, CPE06.formNo, CPE06.status FROM CPE06 INNER JOIN project AS project_5 ON CPE06.PID = project_5.PID WHERE (project_5.PID = @PID)
UNION SELECT project_5.PID, project_5.PNameTH, CPE06.formNo, CPE06.status FROM CPE06 INNER JOIN project AS project_5 ON CPE06.PID = project_5.PID WHERE (project_5.PID = @PID)">
                            <SelectParameters>
