<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Request.aspx.cs" Inherits="sproject.Request" %>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Width="150px" >
                            ...
                            <asp:ListItem Value="1">กรรมการ</asp:ListItem>
                        </asp:DropDownList>
                        </td>
                    <td class="auto-style1"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" PageSize="8" Width="554px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:HyperLinkField DataNavigateUrlFields="PID,FormNo" DataNavigateUrlFormatString="ChooseForm_teacher.aspx?PID={0}&amp;FormNo={1}" Text="ตรวจ" />
                            </Columns>
